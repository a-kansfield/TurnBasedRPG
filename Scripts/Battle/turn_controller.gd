...
func endBattle(winner):
	if winner == "Player":
		get_tree().change_scene_to_file("res://Scenes/Battle/BattleEndScenes/battle_victory.tscn")
	elif winner == "Enemy":
		get_tree().change_scene_to_file("res://Scenes/Battle/BattleEndScenes/battle_defeat.tscn")
